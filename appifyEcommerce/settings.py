"""
Django settings for appifyEcommerce project.
...
ROOT_URLCONF = 'appifyEcommerce.urls'
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': 'django-insecure-3wj88bysg-kn83qq(lrdn1&iqrdl(b+o6rip*&xtx(gov0zzqq',
    'VERIFYING_KEY': None,
